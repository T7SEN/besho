...
│   └── games/                  # Per-game registry + constants. registry.ts (GameDescriptor[] feeding launcher), truth-or-dare-constants.ts (status union, TTLs, prompt/response bounds, Redis key helpers, stats shape)
